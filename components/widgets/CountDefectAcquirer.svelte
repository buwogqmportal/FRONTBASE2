<script lang="ts">
  ...
  $: raportID = user_ID ? 'dashboarddefectacquirercount' : '';
  const name = 'count_defect_acquirer';
</script>

<WidgetCount {title} {edit} {id} {x} {y} {w} {h} {raportID} {name} data={{ user_ID }} color="primary" on:delete>
